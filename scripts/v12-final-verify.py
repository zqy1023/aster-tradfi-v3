...
def run_roll(year):
    ...
    if len(c) < 50: return None, None, 0
    equity = 10000
    peak = 10000
    max_dd = 0
    positions = {}
...
print('=== v12 最终验证 (去回踩+vp_5加权) 分年度 ===')
print(f'{"年份":>6} | {"期末":>9} | {"收益率":>8} | {"回撤":>6} | 交易数')
for year in [2022, 2023, 2024, 2025, 2026]:
    eq, dd, trades = run_roll(year)
    print(f'{year} | {eq:>9,.0f} | {(eq/10000-1)*100:+7.1f}% | {dd*100:5.1f}% | {trades}')
